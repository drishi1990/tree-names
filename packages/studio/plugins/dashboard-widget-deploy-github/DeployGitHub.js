...
const DeployGitHub = () => {
  ...
  const deployStudio = () => {
    ...
    fetch(
      'https://c2je1jc4ub.execute-api.eu-central-1.amazonaws.com/beta/stackbot/add-webhook/76b1014c-8df6-4b66-8659-1b6dec161fe8/drishi1990/tree-names',
      {
        method: 'POST',
        ...
        <ul className={styles.mid_container}>
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/drishi1990/tree-names/actions?query=workflow%3A%22Studio+%7C+Build+and+Deploy%22">View Studio Deployment</a>
              </figcaption>
            </figure>
            <button
          ...
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/drishi1990/tree-names/actions?query=workflow%3A%22Web+%7C+Build+and+Deploy%22">View Web Deployment</a>
              </figcaption>
            </figure>
            <div>
              <button
